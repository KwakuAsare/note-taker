...
## Heroku Deployed
 https://glacial-meadow-74200.herokuapp.com/
...
## Description
Note Taker application is an easy to use application that helps users write down their notes. Users can add notes, edit notes and/or delete the notes they do not want anymore.

## UserStory
AS A user,  
I WANT a note taker app,  
SO THAT I can quickly write down my notes for future reference.  
...
## Usage
Used for adding, editing and deleting important notes and information.
No account creating necessary.
Follow the deployed link and begin using it right away
...
## Repositories
- [Heroku Deployed Link](https://glacial-meadow-74200.herokuapp.com/)
- [GitHub Repository](https://github.com/KwakuAsare/note-taker)
